...
class initial
{
			...
			int   accno ;
			char  name[30], address[60], cno[10], ctype ;
...
/*void control :: help(void)
{
	...
	gotoxy(26,3); cprintf("WELCOME TO CREDIT CARD MAIN.") ;
	textcolor(LIGHTGRAY) ;
	delay(10) ;
	gotoxy(10,6);  cout <<"In  this  Project  you  can keep  record  of credit cards" ;
	delay(10) ;
	gotoxy(10,7);  cout <<"transactions.               " ;
	delay(10) ;
	gotoxy(10,9);  cout <<"    This  program is capable of holding any no. of  account." ;
	delay(10) ;
	gotoxy(10,11); cout <<"- In  first option you can see the details of a  particular" ;
	delay(10) ;
	gotoxy(10,12); cout <<"  credit card holder by giving simply account number" ;
	delay(10) ;
	gotoxy(10,14); cout <<"- In second option you can see the list of all the credit card holders." ;
	delay(10) ;
	gotoxy(10,16); cout <<"- Through third option you can do transactions i.e." ;
	delay(10) ;
	gotoxy(10,17); cout <<"  (Deposit/Withdraw)." ;
	delay(10) ;
	gotoxy(10,19); cout <<"- In Fourth option you can issue a new credit card." ;
	delay(10) ;
	gotoxy(10,20); cout <<"  (NOTE: Opening amount should not less than Rs.500/-" ;
 //	delay(10) ;
	gotoxy(10,22); cout <<"- In Fifth option you can modify or Delete any account." ;
	delay(10) ;
	gotoxy(10,24); cout <<"- And last option is Quit (Exit to Dos).  " ;
	delay(10) ;
...
t_address[60], float t_balance, char t_cno[10], char t_ctype)
{
	accno = t_accno ;
	strcpy(name,t_name) ;
...
void account :: new_account(void)
{
	...
	cout <<"Address : " ;
	gotoxy(5,14) ;
	cout <<"Name of Varifing person : " ;

	gotoxy(5,16) ;
	cout <<"Card Type - G/C/D/E : "<<endl;
...
do
	{
		...
		clear(5,23) ;
		gotoxy(5,23) ;
		cout<<"Gold Card/Clasic Card/Diners Card/Executive Card ";
		valid = 1 ;
		gotoxy(28,16) ;
		cin>>t_ctype ;
		if (t_ctype=='G' || t_ctype=='g')
		t_bal = 70000;
		if (t_ctype=='C' || t_ctype=='c')
		t_bal = 40000;
		if (t_ctype=='D'|| t_ctype=='d')
		t_bal = 15000;
		if (t_ctype=='E' || t_ctype=='e')
		t_bal = 10000;
...
//CARD NO.
	do
	{
		...
		if (t_cno[0] == '0')
			return ;
		if (strlen(t_cno) == 0 || strlen(t_cno) > 10)
		{
			valid = 0 ;
			gotoxy(5,23) ;
			cprintf("\7SHOULD NOT BLANK OR GREATER THAN 10") ;
			getch() ;
		}
	} while (!valid) ;
	...
	ini.add_to_file(t_accno,t_name,t_address,t_balance,t_cno,t_ctype) ;
